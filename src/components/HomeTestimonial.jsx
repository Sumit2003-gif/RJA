      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-6">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <img
              ...
              className="w-full max-w-md h-[300px] sm:h-[350px] md:h-[400px] object-cover rounded-xl shadow-lg"
            />
          </motion.div>
        </AnimatePresence>
        ...
        >
          ...
          <p className="text-gray-600 mb-4 text-sm md:text-base">
            We believe in delivering quality experiences that make a difference.
          </p>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <h4 className="font-semibold text-lg text-gray-800">{testimonials[index].name}</h4>
